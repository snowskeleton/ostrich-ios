...
extension Gamestateschema {
  class GetGameStateV2AtRoundQuery: GraphQLQuery {
    static let operationName: String = "getGameStateV2AtRound"
    static let operationDocument: ApolloAPI.OperationDocument = .init(
      definition: .init(
        #"query getGameStateV2AtRound($eventId: ID!, $round: Int!) { gameStateV2AtRound(eventId: $eventId, round: $round) { ...GameStateDetailsV2 __typename } }"#,
        fragments: [DeckConstructionDetails.self, DraftPod.self, DropDetailsV2.self, GameStateDetailsV2.self, MatchesDetailsV2.self, PodDetailsV2.self, RoundDetailsV2.self, SeatDetailsV2.self, TeamDetailsV2.self, TeamResultDetailsV2.self, TeamStandingsDetailsV2.self, UserDetails.self]
      ))
    ...
    struct Data: Gamestateschema.SelectionSet {
      ...
      static var __selections: [ApolloAPI.Selection] { [
        .field("gameStateV2AtRound", GameStateV2AtRound?.self, arguments: [
          "eventId": .variable("eventId"),
          "round": .variable("round")
        ]),
      ] }

      /// Get a game state at a specified round and ID. Round 0 returns the current round.
      var gameStateV2AtRound: GameStateV2AtRound? { __data["gameStateV2AtRound"] }

      /// GameStateV2AtRound
      ///
      /// Parent Type: `GameStateV2`
      struct GameStateV2AtRound: Gamestateschema.SelectionSet {
        let __data: DataDict
        init(_dataDict: DataDict) { __data = _dataDict }
        ...
        static var __selections: [ApolloAPI.Selection] { [
          ...
          .fragment(GameStateDetailsV2.self),
        ] }
        ...
        struct Draft: Gamestateschema.SelectionSet {
          ...
          struct Pod: Gamestateschema.SelectionSet {
            ...
            /// GameStateV2AtRound.Draft.Pod.Seat
            ///
            /// Parent Type: `SeatV2`
        ...
        struct Top8Draft: Gamestateschema.SelectionSet {
          ...
          /// GameStateV2AtRound.Top8Draft.Pod
          ///
          /// Parent Type: `PodV2`
          struct Pod: Gamestateschema.SelectionSet {
            let __data: DataDict
            ...
            /// GameStateV2AtRound.Top8Draft.Pod.Seat
            ///
            /// Parent Type: `SeatV2`
            struct Seat: Gamestateschema.SelectionSet {
              let __data: DataDict
        ...
        /// GameStateV2AtRound.DeckConstruction
        ///
        ...
        struct DeckConstruction: Gamestateschema.SelectionSet {
          ...
          /// GameStateV2AtRound.DeckConstruction.Seat
          ///
          /// Parent Type: `SeatV2`
          struct Seat: Gamestateschema.SelectionSet {
            let __data: DataDict
