...
extension Gamestateschema {
  class GetGameStateV2AtRoundHostQuery: GraphQLQuery {
    static let operationName: String = "getGameStateV2AtRoundHost"
    static let operationDocument: ApolloAPI.OperationDocument = .init(
      definition: .init(
        #"query getGameStateV2AtRoundHost($eventId: ID!, $round: Int!) { gameStateV2AtRound(eventId: $eventId, round: $round) { ...GameStateV2Host __typename } }"#,
