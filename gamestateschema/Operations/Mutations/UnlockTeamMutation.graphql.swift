...
extension Gamestateschema {
  class UnlockTeamMutation: GraphQLMutation {
    static let operationName: String = "unlockTeam"
    static let operationDocument: ApolloAPI.OperationDocument = .init(
      definition: .init(
        #"mutation unlockTeam($eventId: ID!, $teamCode: String!) { unlockTeam(eventId: $eventId, teamCode: $teamCode) { ...TeamFields __typename } }"#,
    ...
    struct Data: Gamestateschema.SelectionSet {
      ...
      static var __selections: [ApolloAPI.Selection] { [
        .field("unlockTeam", UnlockTeam.self, arguments: [
      ...
      var unlockTeam: UnlockTeam { __data["unlockTeam"] }

      /// UnlockTeam
      ///
      /// Parent Type: `TeamPayload`
      struct UnlockTeam: Gamestateschema.SelectionSet {
        let __data: DataDict
        init(_dataDict: DataDict) { __data = _dataDict }
