...
extension Gamestateschema {
  class SubmitResultsAndCertifyRoundV2Mutation: GraphQLMutation {
    static let operationName: String = "submitResultsAndCertifyRoundV2"
    static let operationDocument: ApolloAPI.OperationDocument = .init(
      definition: .init(
        #"mutation submitResultsAndCertifyRoundV2($eventId: ID!, $results: [TeamResultInputV2!]!) { submitResultsAndCertifyRoundV2(eventId: $eventId, results: $results) { ...GameStateV2Host __typename } }"#,
    ...
    struct Data: Gamestateschema.SelectionSet {
      ...
      static var __selections: [ApolloAPI.Selection] { [
        .field("submitResultsAndCertifyRoundV2", SubmitResultsAndCertifyRoundV2?.self, arguments: [
          "eventId": .variable("eventId"),
          "results": .variable("results")
        ]),
      ] }

      /// Sumbit results and Certify the round. This mutation asks you to send all of the match results for
      ...
      var submitResultsAndCertifyRoundV2: SubmitResultsAndCertifyRoundV2? { __data["submitResultsAndCertifyRoundV2"] }

      /// SubmitResultsAndCertifyRoundV2
      ///
      /// Parent Type: `GameStateV2`
      struct SubmitResultsAndCertifyRoundV2: Gamestateschema.SelectionSet {
        let __data: DataDict
        init(_dataDict: DataDict) { __data = _dataDict }
        ...
        /// SubmitResultsAndCertifyRoundV2.Drop
        ///
        /// Parent Type: `DropV2`
        ...
        /// SubmitResultsAndCertifyRoundV2.Draft
        ///
        /// Parent Type: `DraftV2`
        struct Draft: Gamestateschema.SelectionSet {
          ...
          /// SubmitResultsAndCertifyRoundV2.Draft.Pod
          ///
          /// Parent Type: `PodV2`
          struct Pod: Gamestateschema.SelectionSet {
            ...
            /// SubmitResultsAndCertifyRoundV2.Draft.Pod.Seat
            ///
            /// Parent Type: `SeatV2`
        ...
        /// SubmitResultsAndCertifyRoundV2.Top8Draft
        ///
        /// Parent Type: `DraftV2`
        struct Top8Draft: Gamestateschema.SelectionSet {
          ...
          /// SubmitResultsAndCertifyRoundV2.Top8Draft.Pod
          ///
          /// Parent Type: `PodV2`
          struct Pod: Gamestateschema.SelectionSet {
            let __data: DataDict
            ...
            /// SubmitResultsAndCertifyRoundV2.Top8Draft.Pod.Seat
            ///
            /// Parent Type: `SeatV2`
            struct Seat: Gamestateschema.SelectionSet {
              let __data: DataDict
        ...
        /// SubmitResultsAndCertifyRoundV2.DeckConstruction
        ///
        ...
        struct DeckConstruction: Gamestateschema.SelectionSet {
          ...
          /// SubmitResultsAndCertifyRoundV2.DeckConstruction.Seat
          ///
          /// Parent Type: `SeatV2`
          struct Seat: Gamestateschema.SelectionSet {
            let __data: DataDict
        ...
        /// SubmitResultsAndCertifyRoundV2.Round
        ///
        /// Parent Type: `RoundV2`
        struct Round: Gamestateschema.SelectionSet {
          ...
          /// SubmitResultsAndCertifyRoundV2.Round.Match
          ///
          /// Parent Type: `MatchV2`
          struct Match: Gamestateschema.SelectionSet {
            ...
            /// SubmitResultsAndCertifyRoundV2.Round.Match.Result
            ///
          ...
          /// SubmitResultsAndCertifyRoundV2.Round.Standing
          ///
        ...
        /// SubmitResultsAndCertifyRoundV2.Team
        ///
        /// Parent Type: `TeamV2`
        struct Team: Gamestateschema.SelectionSet {
          ...
          /// SubmitResultsAndCertifyRoundV2.Team.Player
          ///
          /// Parent Type: `User`
