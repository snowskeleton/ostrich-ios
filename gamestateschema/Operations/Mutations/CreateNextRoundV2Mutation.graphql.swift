...
extension Gamestateschema {
  class CreateNextRoundV2Mutation: GraphQLMutation {
    static let operationName: String = "createNextRoundV2"
    static let operationDocument: ApolloAPI.OperationDocument = .init(
      definition: .init(
        #"mutation createNextRoundV2($startPhaseInput: StartPhaseInputV2!) { createNextRoundV2(input: $startPhaseInput) { ...GameStateV2Host __typename } }"#,
    ...
    struct Data: Gamestateschema.SelectionSet {
      ...
      static var __selections: [ApolloAPI.Selection] { [
        .field("createNextRoundV2", CreateNextRoundV2?.self, arguments: ["input": .variable("startPhaseInput")]),
      ] }

      /// Create the next round of an event, which might be the first round if none have yet been
      /// created. Returns a GameState.
      var createNextRoundV2: CreateNextRoundV2? { __data["createNextRoundV2"] }

      /// CreateNextRoundV2
      ///
      /// Parent Type: `GameStateV2`
      struct CreateNextRoundV2: Gamestateschema.SelectionSet {
        let __data: DataDict
        init(_dataDict: DataDict) { __data = _dataDict }
        ...
        struct Draft: Gamestateschema.SelectionSet {
          ...
          struct Pod: Gamestateschema.SelectionSet {
            ...
            /// CreateNextRoundV2.Draft.Pod.Seat
            ///
            /// Parent Type: `SeatV2`
        ...
        struct Top8Draft: Gamestateschema.SelectionSet {
          ...
          /// CreateNextRoundV2.Top8Draft.Pod
          ///
          /// Parent Type: `PodV2`
          struct Pod: Gamestateschema.SelectionSet {
            let __data: DataDict
            ...
            /// CreateNextRoundV2.Top8Draft.Pod.Seat
            ///
            /// Parent Type: `SeatV2`
            struct Seat: Gamestateschema.SelectionSet {
              let __data: DataDict
        ...
        /// CreateNextRoundV2.DeckConstruction
        ///
        ...
        struct DeckConstruction: Gamestateschema.SelectionSet {
          ...
          /// CreateNextRoundV2.DeckConstruction.Seat
          ///
          /// Parent Type: `SeatV2`
          struct Seat: Gamestateschema.SelectionSet {
            let __data: DataDict
        ...
        struct Round: Gamestateschema.SelectionSet {
          ...
          struct Match: Gamestateschema.SelectionSet {
            ...
            /// CreateNextRoundV2.Round.Match.Result
            ///
          ...
          /// CreateNextRoundV2.Round.Standing
          ///
