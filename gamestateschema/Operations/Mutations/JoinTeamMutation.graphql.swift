...
extension Gamestateschema {
  class JoinTeamMutation: GraphQLMutation {
    static let operationName: String = "joinTeam"
    static let operationDocument: ApolloAPI.OperationDocument = .init(
      definition: .init(
        #"mutation joinTeam($eventId: ID!, $teamCode: String!, $teamPlayer: TeamPlayerInput!) { addTeamMember(eventId: $eventId, teamCode: $teamCode, teamPlayer: $teamPlayer) { ...TeamFields __typename } }"#,
    ...
    struct Data: Gamestateschema.SelectionSet {
      ...
      static var __selections: [ApolloAPI.Selection] { [
        .field("addTeamMember", AddTeamMember.self, arguments: [
      ...
      var addTeamMember: AddTeamMember { __data["addTeamMember"] }

      /// AddTeamMember
      ///
      /// Parent Type: `TeamPayload`
      struct AddTeamMember: Gamestateschema.SelectionSet {
        let __data: DataDict
        init(_dataDict: DataDict) { __data = _dataDict }
