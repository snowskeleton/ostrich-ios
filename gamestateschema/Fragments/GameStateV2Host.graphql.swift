...
extension Gamestateschema {
  struct GameStateV2Host: Gamestateschema.SelectionSet, Fragment {
    static var fragmentDefinition: StaticString {
      #"fragment GameStateV2Host on GameStateV2 { __typename ...GameStateDetailsV2 drops { ...DropDetailsV2 __typename } }"#
    }
