...
struct CreateFakeEventView: View {
    ...
    func createFakeEvent() {
        ...
        let event = Event(
            ...
            teams: teams,
            shortCode: "TESTEVENT",
            scheduledStartTime: self.scheduledStartTime.iso8601,
            actualStartTime: self.scheduledStartTime.iso8601,
        ...
        let rounds = (1...self.minRounds).map { roundNumber in
            let round = Round(
                roundId: UUID().uuidString,
                roundNumber: roundNumber,
                isFinalRound: roundNumber == self.minRounds,
                gameState: gameState
            )
